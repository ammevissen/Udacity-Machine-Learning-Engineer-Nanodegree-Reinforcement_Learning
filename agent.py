...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        #self.epsilon=.95**self.trial
        self.epsilon=math.cos(self.trial*math.pi/200)/2.0+0.5
    ...
    def choose_action(self, state):
        ...
        ##Random:
        #from random import randint  #####my Code
        #action = self.env.valid_actions[random.randint(0,3))]#####my Code
        ## End Random
